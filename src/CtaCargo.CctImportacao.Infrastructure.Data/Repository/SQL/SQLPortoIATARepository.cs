...
namespace CtaCargo.CctImportacao.Infrastructure.Data.Repository.SQL
{
    public class SQLPortoIATARepository : IPortoIATARepository
    {
        ...
        public async Task<PortoIata> GetPortoIATAById(int portoIATAId)
        {
            return await _context.PortosIATA.FirstOrDefaultAsync(x => x.Id == portoIATAId && x.DataExclusao == null);
        }
