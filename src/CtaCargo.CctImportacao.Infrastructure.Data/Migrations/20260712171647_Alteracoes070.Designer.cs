...
namespace CtaCargo.CctImportacao.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260712171647_Alteracoes070")]
    partial class Alteracoes070
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CtaCargo.CctImportacao.Domain.Entities.House", b =>
                {
                    ...
                    b.Property<string>("NaturezaCargaLista")
                        .HasColumnType("varchar(120)");
                    ...
                    b.Property<decimal>("ValorAgenteFC")
                        .HasColumnType("MONEY");

                    b.Property<decimal>("ValorAgentePP")
                        .HasColumnType("MONEY");
                    ...
                    b.Property<decimal>("ValorTransportadorFC")
                        .HasColumnType("MONEY");

                    b.Property<decimal>("ValorTransportadorPP")
                        .HasColumnType("MONEY");
            ...
            modelBuilder.Entity("CtaCargo.CctImportacao.Domain.Entities.HouseTratamentoEspecial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HouseTratamentoEspecial");
                });
            ...
            modelBuilder.Entity("CtaCargo.CctImportacao.Domain.Entities.Master", b =>
                {
                    ...
                    b.Property<string>("StatusCodeRFB")
                        .HasColumnType("varchar(15)");
            ...
            modelBuilder.Entity("CtaCargo.CctImportacao.Domain.Entities.MasterTratamentoEspecial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MasterTratamentoEspecial", (string)null);
                });

            modelBuilder.Entity("CtaCargo.CctImportacao.Domain.Entities.MessageSubmitFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FilePurpose", "SourceId");

                    b.ToTable("MessageSubmitFile", (string)null);
                });
            ...
            modelBuilder.Entity("CtaCargo.CctImportacao.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.HasIndex("EmpresaId", "Account", "DataExclusao")
                        .IsUnique();
            ...
            modelBuilder.Entity("CtaCargo.CctImportacao.Infrastructure.Data.Context.ResumoVooUldView", b =>
                {
                    ...
                    b.ToView("ResumoVooUldView", (string)null);
                });
            ...
            modelBuilder.Entity("CtaCargo.CctImportacao.Domain.Entities.MasterTratamentoEspecial", b =>
                {
                    ...
                    b.HasOne("CtaCargo.CctImportacao.Domain.Entities.Master", "Master")
                        .WithMany("TratamentosEspeciais")
                        .HasForeignKey("MasterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CtaCargo.CctImportacao.Domain.Entities.House", b =>
                {
                    b.Navigation("TratamentosEspeciais");
                });
