...
public class MasterHouseAssociacao : BaseEntity
{
    ...
    [Column(TypeName = "varchar(40)")]
    public string CodigoErroDeletionAssociacaoRFB { get; set; }
    [Column(TypeName = "text")]
    public string DescricaoErroDeletionAssociacaoRFB { get; set; }
    public int SituacaoDeletionAssociacaoRFBId { get; set; } // “Received” , “Rejected”, “Processed”
    public DateTime? DataProtocoloDeletionAssociacaoRFB { get; set; }
