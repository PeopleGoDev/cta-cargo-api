...
public interface IMasterRepository
{
    ...
    void UpdateMasterTratamentoEspecial(MasterTratamentoEspecial tratamentoEspecial);
    void InsertMasterTratamentoEspecial(MasterTratamentoEspecial tratamentoEspecial);
}