...
namespace CtaCargo.CctImportacao.Application.Services.Contracts
{
    public interface ISubmeterReceitaService
    {
        ...
        // Task<ApiResponse<string>> UpdateItineraryTime(UserSession userSession, ConfirmDepartureRequest input);
        ...
        Task<ApiResponse<string>> CancelarAssociacaoHousesMaster(UserSession userSession, int associationId);
    }
}